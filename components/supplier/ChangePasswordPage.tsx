...
export default function ChangePasswordPage() {
  ...
  if (!loading && (!user || user.kind !== "supplier")) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 max-w-md w-full">
        <h1 className="text-xl font-bold text-[#0f2d5e] mb-1">Đặt mật khẩu mới</h1>
        <p className="text-sm text-slate-500 mb-6">
          {user?.mustChangePassword
            ? "Bạn cần đặt mật khẩu mới trước khi tiếp tục sử dụng hệ thống."
            : "Thay đổi mật khẩu tài khoản nhà cung cấp."}
        </p>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder={user?.mustChangePassword ? "Mật khẩu tạm thời trong email" : "Mật khẩu hiện tại"}
