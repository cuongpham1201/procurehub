    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-10 max-w-md w-full text-center">
        ...
        <p className="text-sm text-slate-500 mb-8 leading-relaxed">
          Bạn cần đăng nhập tài khoản nội bộ Bia Hạ Long để truy cập khu vực
          quản trị. Liên hệ quản trị hệ thống nếu chưa có tài khoản.
        </p>

        <div className="flex flex-col gap-3">
          <Link
            href="/login?type=internal"
      ...
      <p className="mt-6 text-xs text-slate-400">
        Bia Hạ Long Procurement · Cổng quản trị nội bộ
      </p>
    </div>
  );
}
...
export default function AdminAuthGuard({
  ...
  useEffect(() => {
    const user: InternalUser | null = getInternalSession();
